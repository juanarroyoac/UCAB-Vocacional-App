    ...
    <div className="about-test-container">
      ...
      <header className="ucab-header">
        ...
        <div className="header-actions">
          <a href="https://www.ucab.edu.ve/pregrado/" className="career-link" target="_blank" rel="noopener noreferrer">
            Áreas Profesionales
          </a>
          <a href="/acerca" className="career-link">
            Acerca del test
          </a>
          <a href="/" className="test-button">
            Haz el test
          </a>
        </div>
      </header>
        ...
        >
          <defs>
            <linearGradient id="aboutGradient" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#A9D6E5" />
      ...
      <section className="about-content">
        <div className="about-card">
          ...
          <p>
            El Test Vocacional UCAB es una herramienta interactiva diseñada para ayudarte a descubrir tus intereses,
            habilidades y valores profesionales. A través de preguntas cuidadosamente seleccionadas, podrás identificar
            áreas de estudio y carreras que se alinean con tu perfil personal.
          </p>
        </div>
        ...
        <div className="about-card about-card-row">
          <div>
            ...
            <p>
              Elegir una carrera es una de las decisiones más importantes de tu vida. Este test te brinda una guía
              moderna y confiable para tomar decisiones informadas sobre tu futuro académico y profesional.
            </p>
          </div>
        ...
        <div className="about-card about-card-highlight about-card-buttons no-bg-card">
          <div className="about-buttons-container">
            <a
              href="https://www.ucab.edu.ve/oferta-academica/carreras/"
              target="_blank"
              rel="noopener noreferrer"
              className="about-btn about-btn-careers"
            >
              Ver carreras UCAB
            </a>
            <button
              className="about-btn about-btn-test"
